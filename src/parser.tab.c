...
#line 125 "parser.tab.c" /* yacc.c:339  */
...
{
       0,    90,    90,    91,    92,    93,    96,    97,   104,   105,
     106,   107,   108,   109,   110,   111,   112,   113,   114,   115,
     116,   119,   120,   122,   123,   126,   127,   138,   142
};
#endif
...
{
  "$end", "error", "$undefined", "NUM", "NAME", "FUNC", "EOL", "IF",
...
#line 127 "parser.y" /* yacc.c:1646  */
    ...
    init();
    print(convert_ast((yyvsp[-1].a)));
    printf("\n");
    print(eval(convert_ast((yyvsp[-1].a)), the_global_environment));
    printf("\n");
    printf(">");
    //printf("= %4.4g\n> ", evaluate($2));
     treefree((yyvsp[-1].a));
