...
/**
 *make symbol is used to generate an object of type symbol i.e.
 * Parameters:
...
char is_symbol(object *obj) { return obj->obj_type == SYMBOL; }
  ...
  /**
   *make_fixnum is used to generate an object of type FIXNUM which we use as ints
   * Parameters:
...
/**
 *make_character is used to generate an object of type char i.e. 'a', '4' etc.
 * Parameters:
...
/**
 *make_string is used to generate an object of type String
 * Parameters:
...
/**
 *char_to_enum is used determine the enumuration of the sent in char pointer
 * Parameters:
...
/**
 *set_acceptables is used to determine the acceptable types for an operator in our typechecker
 * Parameters:
...
/**
 *make_primitive_proc is used to assign the primitive type to an object as well as updating the objects acceptables list by calling set_acceptables
 * Parameters:
...
/**
 *sub_proc is used to actually preform the named calculation
...
/**
 *mul_proc is used to actually preform the named calculation
...
/**
 *quotient_proc is used to actually preform the named calculation
 *used for division
 * Parameters:
 *-arguements, the actual list of arguements for the procedure
 * Returns:
...
/**
 *remainder_proc is used to actually preform the named calculation
...
/**
 *This function is used ti lookup a variable from our environment
 * Parameters:
...
/**
 *This function is used to check a variables type
 * Parameters:
 *-var, the variable we are check the type of
 *-env, the environment the variable is in
 * Returns:
 *-car(vals), the values of the car of the sent in list var
 * Throws:
 *-unbound variable, this error is triggered is the specified variable has no type.
 */
