...
static const char *const yytname[] =
{
  ...
  "THEN", "ELSE", "WHILE", "DO", "FUN", "FOR", "END", "CMP", "'='", "'+'",
  "'-'", "'*'", "'/'", "'%'", "'|'", "UMINUS", "'('", "')'", "'{'", "'}'",
...
static const yytype_uint16 yytoknum[] =
{
     ...
     265,   266,   267,   268,   269,   270,    61,    43,    45,    42,
      47,    37,   124,   271,    40,    41,   123,   125,    59,    44
};
# endif
...
{
     -15,    23,   -15,   -15,   -15,   -11,   -13,   -15,   -12,    -9,
      10,    70,    70,    70,    -6,   112,    70,    70,    70,    70,
      70,     1,   -15,   -15,    85,   -15,    70,    70,    70,    70,
      70,    70,    61,    78,     6,     9,    94,   103,    36,   -15,
     119,    18,    18,   -15,   -15,   -15,    70,   -15,   -15,    22,
      24,    25,    31,   -15,    48,    48,    36,    33,    32,    35,
      37,   -15,    48,    48,    59,   -15,    44,   -15,    39,   -15,
      48,   -15,    56,   -15
};
...
{
      29,     0,     1,    33,    18,    20,     0,    30,     0,     0,
       0,     0,     0,     0,     0,     6,     0,    23,    23,     0,
       0,     0,    17,    15,     0,    31,     0,     0,     0,     0,
       0,     0,    21,    24,     0,     0,     0,     0,    26,    16,
       9,    10,    11,    12,    13,    14,    23,    22,    19,     0,
       0,    27,     0,    25,     7,     7,    26,     0,     0,     0,
       0,    28,     7,     7,     2,     5,     0,     8,     0,    32,
       7,     4,     0,     3
};
...
{
      14,    22,    23,    24,    35,    16,    32,    33,    33,    36,
      37,    18,    19,    17,    21,    20,    40,    41,    42,    43,
      44,    45,    25,     2,     3,    38,     4,     5,     6,     7,
       8,    47,    53,     9,    48,    10,    33,    29,    30,    31,
      51,    11,     4,     5,     6,    12,     8,    13,    54,     9,
      55,     4,     5,     6,    56,     8,    57,    11,     9,    62,
      63,    12,    64,    13,    65,    70,    11,    71,    68,    60,
      12,    69,    13,     4,     5,     6,    66,    67,    27,    28,
      29,    30,    31,    73,    72,    61,     0,     0,    11,     0,
       0,     0,    12,    26,    13,    27,    28,    29,    30,    31,
      26,     0,    27,    28,    29,    30,    31,    46,     0,    26,
      39,    27,    28,    29,    30,    31,     0,     0,    26,    49,
      27,    28,    29,    30,    31,     0,     0,    26,    50,    27,
      28,    29,    30,    31,    -1,     0,    27,    28,    29,    30,
      31
};

static const yytype_int8 yycheck[] =
{
       1,    11,    12,    13,    18,    16,    16,    17,    18,    19,
      20,    24,    24,    24,     4,    24,    26,    27,    28,    29,
      30,    31,    28,     0,     1,    24,     3,     4,     5,     6,
       7,    25,    46,    10,    25,    12,    46,    19,    20,    21,
       4,    18,     3,     4,     5,    22,     7,    24,    26,    10,
      26,     3,     4,     5,    29,     7,    25,    18,    10,    26,
      28,    22,    27,    24,    27,    26,    18,    68,     9,    55,
      22,    27,    24,     3,     4,     5,    62,    63,    17,    18,
      19,    20,    21,    27,    70,    56,    -1,    -1,    18,    -1,
      -1,    -1,    22,    15,    24,    17,    18,    19,    20,    21,
      15,    -1,    17,    18,    19,    20,    21,    29,    -1,    15,
      25,    17,    18,    19,    20,    21,    -1,    -1,    15,    25,
      17,    18,    19,    20,    21,    -1,    -1,    15,    25,    17,
      18,    19,    20,    21,    15,    -1,    17,    18,    19,    20,
      21
};
...
{
       0,    36,     0,     1,     3,     4,     5,     6,     7,    10,
      12,    18,    22,    24,    31,    33,    16,    24,    24,    24,
      24,     4,    33,    33,    33,    28,    15,    17,    18,    19,
      20,    21,    33,    33,    34,    34,    33,    33,    24,    25,
      33,    33,    33,    33,    33,    33,    29,    25,    25,    25,
      25,     4,    35,    34,    26,    26,    29,    25,    31,    32,
      32,    35,    26,    28,    27,    27,    32,    32,     9,    27,
      26,    31,    32,    27
};
...
#line 78 "parser.y" /* yacc.c:1646  */
    { if(debug) dumpast((yyvsp[-1].a), 0); print(convert_expr((yyvsp[-1].a))); treefree((yyvsp[-1].a)); printf("\n"); }
